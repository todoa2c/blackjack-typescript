...
describe('Game Class', () => {
    it('have two cards for player and cpu', () => {
        ...
        game.initialDraw()
        assert(game.player.cards.length === 2)
        assert(game.player.cards[0] === cards[0])
        assert(game.player.cards[1] === cards[1])
        assert(game.player.score() === 12)
        assert(game.cpu.cards.length === 2)
        assert(game.cpu.cards[0] === cards[2])
        assert(game.cpu.cards[1] === cards[3])
        assert(game.cpu.score() === 18)
